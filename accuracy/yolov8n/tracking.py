...
tracker = BYTETracker(TrackerArgs(), frame_rate=15)
...
if __name__ == '__main__':
    ...
    for idx, img_name in enumerate(img_list):
        ...
        if boxes is not None:
            ...
            online_targets = tracker.update(detections, [h,w], (640, 640))
            ...
            for t in online_targets:
                ...
                left = (tlbr[0] - pad_left) / ratio
                top = (tlbr[1] - pad_top) / ratio
                right = (tlbr[2] - pad_left) / ratio
                bottom = (tlbr[3] - pad_top) / ratio
